<template>
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <RouterLink to="/student/postulations" class="nav-item" active-class="active">
        <i class="fas fa-user"></i>
        <span>Mis Postulaciones</span>
      </RouterLink>

      <RouterLink to="/student/configuration" class="nav-item" active-class="active">
        <i class="fas fa-user"></i>
